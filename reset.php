...
<head>
  <meta charset="utf-8">
    ...
    <title>Wallet Infinity - Reset Password </title>
...
<div class="lockscreen-wrapper">
	  ...
	  <div class="lockscreen-item">
	    ...
	    <!-- User name -->
	    <div class="lockscreen-name margin-top-20"><h3>Reset Password</h3></div>
	    <div class="lockscreen-name margin-top-20"><h4>Please Enter Your Email</h4></div>
        <div class="lockscreen-name"><p>We will send you a password reset link within 24 hours</p></div>
