  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Transactions Counter</li>
      </ol>
    </section>
    ...
    <section class="content">	  
      ...
      <!-- /.box -->
      <!-- Default box -->
	  <div class="box box-inverse box-primary bg-hexagons-white">
        <div class="box-body">
			<div class="row">
				<div class="col-md-3 col-12">
				 	<div class="text-center">
      ...
      <!-- /.box -->
      <!-- Default box -->
	  <div class="box box-inverse box-yellow bg-hexagons-dark">
        <div class="box-body">
			<div class="row">
				<div class="col-md-3 col-12">
				 	<div class="text-center">
