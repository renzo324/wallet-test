  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Transactions Search</li>
      </ol>
    </section>
    ...
    <section class="content">
	  ...
	  <div class="row">
		<div class="col-lg-6 col-12">	  
		  ...
		  <div class="box">
			<div class="box-body">
				<h3><a href="#">Transactions Id</a></h3>
				<div class="row justify-content-between">
				  <div class="col-md-auto">
					  <h5><a href="#">db12458rtfd1254</a>
					  <i class="fa fa-long-arrow-right text-green px-15"></i>
					  <a href="#">cde124587rtyg15468</a></h5>
				  </div>
				  <div class="col-md-auto">
					  <h5 class="text-bold text-right">0.35473875 BTC</h5>
				  </div>
				</div>
				<div class="mt-30">
					<span class="badge badge-xl badge-primary mr-5 pull-left">45 Confirmation</span>
					<span class="badge badge-xl badge-success pull-right">1.124589756 BTC</span>
				</div>
			</div>
			<!-- /.box-body -->
		  </div>      
